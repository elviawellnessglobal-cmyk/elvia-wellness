...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About KAEORN</title>
        <meta
          name="description"
          content="Learn about KAEORN — a brand built on the philosophy of quiet luxury, skincare-inspired fragrances, and everyday elegance."
        />
      </Helmet>
      ...
      <div style={styles.page}>
        ...
        <p style={styles.text}>
          ...
          designed to be effective, gentle, and purposeful — avoiding
          unnecessary additives while focusing on results that respect the skin
          barrier.
        </p>
